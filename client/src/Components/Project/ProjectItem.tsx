...
function ProjectItem(project: IProjet): JSX.Element {
  ...
  const moreInfoHS = (event: React.MouseEvent<HTMLButtonElement>): any => {
    ...
    let BtnSlide: HTMLElement | null = document.getElementById(
      project.id.toString()
    );
  ...
  return (
    <div
      id="card"
      className="lg:w-5/12 w-9/12 m-6 rounded-md drop-shadow-xl shadow-xl shadow-blue-800/50 bg-white"
    >
      <div id="additional" className="w-full rounded-md">
        <div
          id="user-card"
          className="w-4/4 h-12 place-items-center justify-items-center flex  bg-sky-300 rounded-md"
        >
          ...
          <a
            id="open"
            href="http://localhost:3000/projetDetails"
            className="ti-fullscreen text-sky-600 bg-white rounded-full p-2 m-2"
          ></a>
          <button
          ...
          <div className="flex">
            ...
            <div className="w-5/6 mx-4 block">
              ...
              <div className=" grid grid-cols-2 w-full justify-items-center">
                <div>
                  <div className="title font-bold text-xs text-center uppercase text-slate-900">
                    Status
                  </div>
                ...
                <div>
                  <div className="title font-bold text-xs uppercase text-center text-slate-900">
                    Numbers Ticket
                  </div>
                  <div className="value font-bold text-2xl text-center text-slate-900">
                ...
                <div className="px-8 py-4">
                  <div id="Start" className="text-base">
                    Start : {project.start_time.toString().substring(0, 10)}
                  </div>
                </div>
              </div>
            </div>
